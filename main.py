...
PM_START_TEXT = """
Ciao {}, Io sono il bot della Ilooh Technology Inc. Aggiungimi ad un gruppo, così ti aiuto a gestirlo. Per informazioni, scrivi una mail a : info@iloohtechnology.rf.gd.
Il Bot è iscritto al network @iloohbotnetwork.
"""
...
I *principali* comandi disponibili sono:
 - /start: avvia il bot
 Comandi nei gruppi:
 - /ban: banna gli utenti dal gruppo
 - /kick: espelle gli utenti temporaneamente
  - altri: arriverranno altri comandi
...
Attualmente il sistema di donazione non è attivo, rimani sintonizzato"""
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if DONATION_LINK:
            update.effective_message.reply_text(
                "Puoi donare qui " "[here]({})".format(DONATION_LINK),
                parse_mode=ParseMode.MARKDOWN,
            )
